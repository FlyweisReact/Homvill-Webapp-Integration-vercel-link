// New sellHomeSlice for form state management
import { createSlice } from '@reduxjs/toolkit';

const initialState = {
  Properties_Status_id: 2,
...
const sellHomeSlice = createSlice({
  name: 'sellHome',
  initialState,
  reducers: {
...
export const { updateFormData, resetForm } = sellHomeSlice.actions;
export default sellHomeSlice.reducer;