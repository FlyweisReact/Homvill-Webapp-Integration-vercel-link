...
const FeaturedCategories = () => {
    return (
        <div className="w-full bg-[#F7F7F7] px-4 sm:px-8 md:px-24 !py-8 overflow-hidden">
            {/* Header */}
            <div className="flex flex-col sm:flex-row justify-center items-center sm:items-center mb-4">
