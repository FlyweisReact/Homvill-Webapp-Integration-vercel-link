...
import 'swiper/css';
import 'swiper/css/scrollbar';
import rental from '../assets/chicago.svg';
import land from '../assets/los.svg';
import town from '../assets/miami.svg';
import modern from '../assets/florida.jpg';
import apart from '../assets/newyork.jpg';
import re from '../assets/re.jpg';
import office from '../assets/office.jpg';
import contract from '../assets/contract.jpg';
import home from '../assets/home.jpg';
...
const FeaturedCategories = () => {
    return (
        <div className="w-full bg-[#F7F7F7] px-4 sm:px-8 md:px-12 !py-10 overflow-hidden">
            {/* Header */}
            <div className="flex flex-col sm:flex-row justify-center items-center sm:items-center mb-6">
                <div style={{ fontFamily: 'Poppins' }}>
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[40px] font-semibold">
                        Find Properties in These Cities
                    </h2>
                    <p className="text-sm sm:text-base md:text-[17px] text-center  mt-4  text-gray-500">
            ...
            <style jsx>{`
                /* Hide the default Swiper scrollbar */
                .swiper-scrollbar:not(.custom-scrollbar) {
                    display: none !important;
                }
