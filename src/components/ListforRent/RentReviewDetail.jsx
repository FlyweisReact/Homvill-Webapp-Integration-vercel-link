          ...
          <div className="mx-auto max-w-4xl">
            <div className="bg-white p-3 sm:p-4 rounded-lg text-sm sm:text-base md:text-lg lg:text-[24px] shadow-md mb-3 sm:mb-4">
              ...
              <div className="ml-14 sm:ml-16 lg:ml-20 mt-2 space-y-1">
                ...
                <p className="text-black mulish-font"><span className="font-medium text-[#00000080]">For rent:</span> ${formData.Property_Listing_Price}</p>
                <p className="text-black mulish-font"><span className="font-medium text-[#00000080]">Home Facts:</span> House Renting</p>
              </div>
            </div>
            ...
            <div className="bg-white p-3 sm:p-4 rounded-lg text-sm sm:text-base md:text-lg lg:text-[24px] shadow-md mt-3 sm:mt-8">
              <div className="flex items-center justify-between">
                ...
                <svg
                  onClick={() => navigate('/rentdescription')}
                  className="w-4 h-4 sm:w-5 sm:h-5 text-[#8A1538] cursor-pointer"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
            ...
            <div className="bg-white p-3 sm:p-4 rounded-lg text-sm sm:text-base md:text-lg lg:text-[24px] shadow-md mt-3 sm:mt-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <h2 className="text-lg sm:text-xl md:text-2xl lg:text-[30px] mulish-font ml-2 font-semibold">Landlord Information</h2>
                </div>
                <svg
                  onClick={() => navigate('/rentdetails')}
                  className="w-4 h-4 sm:w-5 sm:h-5 text-[#8A1538] cursor-pointer"
