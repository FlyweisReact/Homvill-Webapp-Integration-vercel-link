...
import sideImage from "../assets/right7.svg";
...
const RentVideo = () => {
  ...
  const handleNext = () => {
    dispatch(updateFormData({ Video_tour_link: links.length ? links : ["http://google.com", "http://india.in"] }));
    navigate('/rentbuyer');
  };
