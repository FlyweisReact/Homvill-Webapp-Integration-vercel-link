// RentListing component
import React, { useState, useEffect } from "react";
import sideImage from "../assets/right4.svg";
...
const RentListing = () => {
  ...
  const handleNext = () => {
    dispatch(updateFormData({
      ...
      Property_cost: listingPrice,
      Property_Listing_plot_size: formDataFromStore.Property_Plot_size,
    }));
    navigate('/rentdescription');
  };
      ...
      <div className="min-h-screen flex flex-col md:flex-row">
        <div className="w-full lg:w-2/3 p-6 md:p-12">
          ...
          <div className=" space-y-6">
            ...
            <div className="bg-[#F7F7F7] p-4 mb-12">
              ...
              <p className="md:text-[24px] mulish-font text-black">
                Homes in <span className="font-semibold">90027</span> rented
          ...
          <div className="flex flex-col sm:flex-row justify-between text-[20px] mulish-font gap-4 sm:gap-20 mt-12">
            <button
              onClick={() => navigate('/rentimprovement')}
