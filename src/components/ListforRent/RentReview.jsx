// RentReview component (provided, updated with Redux for rent slice)
    ...
    <>
      ...
      >
        <div style={{ fontFamily: 'Poppins' }} className="text-white">
          <h1 className="text-3xl sm:text-[45px] font-semibold leading-[1.1] text-white mulish-font">
          ...
          <div className="mt-6 flex items-center bg-white rounded-lg overflow-hidden w-full max-w-md">
            <input
              type="text"
              placeholder="Enter your property address you want to rent"
            ...
            <button 
              ...
              className={`bg-[#8A1538] hover:bg-[#72152e] text-white p-3 mr-2 rounded-lg ${!searchInput.trim() ? 'opacity-50 cursor-not-allowed' : ''}`}
      ...
      <div style={{ fontFamily: 'Poppins' }} className="w-full bg-[#F7F7F7] px-4 md:px-8 lg:px-24 py-8 lg:py-12 space-y-12">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h3 className="text-xl sm:text-2xl lg:text-[32px] text-[#000000] font-semibold mb-3 mulish-font">
              You can rent directly to Opendoor hassle-free
            </h3>
            <p className="text-[#000000] text-base sm:text-lg lg:text-[20px] leading-relaxed">
              Get an all-cash offer from our trusted partner, Opendoor, to rent your home on your timeline and avoid the hassle of showings.*
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row-reverse items-center gap-6 lg:gap-10">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h3 className="text-xl sm:text-2xl lg:text-[32px] text-[#000000] font-semibold mb-3 mulish-font leading-tight">
              You can rent for more money with a app name partner agent
            </h3>
            <p className="text-[#000000] text-base sm:text-lg lg:text-[20px] leading-relaxed">
              Select app partner agents offer Showcase listings, which rent for 2% more – that’s more than $9K on a home rented at the average home rental price
            </p>
          </div>
          <div className="w-full lg:w-1/2">
            <img
