    ...
    return (
        <>
            ...
            <div className="px-8 w-full flex flex-col md:flex-row items-stretch">
                {/* Left Section */}
                <div className="md:w-1/2  p-6 flex flex-col lg:justify-center">
                    ...
                    <div className="w-full lg:max-w-sm space-y-8">
                     <div className='space-y-4'>
                        ...
                        <p
                            ...
                            className="text-[16px] text-[#2C2E38] text-center"
                        >
                            Already have an account? <span className="text-[#8A1538] font-medium cursor-pointer"><Link to={'/signin'}>Sign In</Link></span> here
                        </p>
                        <div
                            style={{ fontFamily: 'Poppins' }}
                            className="space-y-3"
