...
//     return (
//         <div className="w-full px-12 py-10 overflow-hidden">
//             {/* Header */}
//             <div className="flex justify-between items-center mb-6">
//                 <div style={{fontFamily:'Poppins'}}>
//                     <h2 className="text-[40px] font-semibold">Featured Categories</h2>
//                     <p className="text-[17px] text-gray-500">Lorem ipsum dolor sit amet</p>
//                 </div>
//                 <a style={{fontFamily:'Poppins'}} href="#" className="text-[15px] font-medium text-black flex items-center gap-1">
...
//                         <SwiperSlide key={index} className="w-[338px] h-[408px]">
//                             <div className="rounded-xl overflow-hidden relative group shadow-md w-[338px] h-[408px]">
//                                 <img
//                                     src={item.image}
//                                     alt={item.title}
...
//                                 >
//                                     <h3 className="text-[32px] font-semibold leading-[1.1]">{item.title}</h3>
//                                     <p className="text-[24px]">{item.properties}</p>
//                                 </div>
//                             </div>
//                         </SwiperSlide>
//                     ))}
...
//                     width: 329px !important; /* Fixed width as per original design */
...
// const FeaturedCategories = () => {
//     return (
//         <div className="w-full px-4 sm:px-8 md:px-12 py-10 overflow-hidden">
//             {/* Header */}
//             <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
//                 <div style={{ fontFamily: 'Poppins' }}>
//                     <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[40px] font-semibold">
//                         Featured Categories
//                     </h2>
//                     <p className="text-sm sm:text-base md:text-[17px] text-gray-500">
...
//                             <div className="rounded-xl overflow-hidden relative group shadow-md w-full max-w-[338px] aspect-[338/408]">
//                                 <img
//                                     src={item.image}
//                                     alt={item.title}
//                                     className="w-full h-full object-cover"
...
//                 .swiper-slide {
//                     width: calc(100vw - 2rem) !important; /* Default for small screens */
//                 }

//                 @media (min-width: 480px) {
//                     .swiper-slide {
//                         width: calc((100vw - 3rem) / 1.5) !important;
//                     }
//                 }
