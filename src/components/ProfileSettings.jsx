...
const ProfileSettings = () => {
    ...
    const [selectedReason, setSelectedReason] = useState('');
    const [comment, setComment] = useState('');
    const [fetchingItem, setFetchingItem] = useState(null); // Track which Edit button is fetching
    const [updatingField, setUpdatingField] = useState(null); // Track which Save button is updating
    const [currentPassword, setCurrentPassword] = useState(''); // Current password for change password
    ...
    // State for Name modal inputs
    const [firstName, setFirstName] = useState(userData.Name);
    const [lastName, setLastName] = useState(userData.last_name);
    // State for Email/Phone modal inputs
