...
//                 {/* Left Section */}
//                 <div className=" relative md:w-1/2 bg-white p-6 flex flex-col justify-center">
...
//  style={{ fontFamily: 'Poppins' }} className="text-[18px] text-gray-600 mb-6 text-left z-10">&larr; Back</button>
//                     <h1 style={{ fontFamily: 'Poppins' }} className="text-3xl md:text-[42px] font-bold leading-[1.2] text-gray-900 mb-3 z-10">
//                         Buy, sell or rent your dream homes
//                     </h1>
//                     <p style={{ fontFamily: 'Poppins' }} className="text-[#000000] mb-8 z-10">Lorem Ipsum is simply dummy text</p>
//                     <h2 style={{ fontFamily: 'Poppins' }} className="text-[25px] font-medium text-gray-900 mb-3 z-10">Get an App</h2>
//                     <div className="relative w-full">
//                         <img src={bg} alt="House" className="rounded-xl w-[680px] h-auto" />
//                         <div className="absolute top-[-85px] right-[214px]  p-2 rounded-md  flex items-center justify-center">
//                             <img src={qr} alt="QR Code" className="w-auto h-[263px] object-contain" />
//                         </div>
//                     </div>
//                 </div>
...
//                         />
//                         <button style={{ fontFamily: 'Poppins' }} className="w-full bg-[#8A1538] hover:bg-[#72152e] text-white text-[18px] py-3 rounded-md font-semibold shadow-md">
//                             Continue
//                         </button>
//                         <p style={{ fontFamily: 'Poppins' }} className="text-[16px] text-gray-600 text-center">
//                             By signing in you agree to our{' '}
//                             <span className="text-pink-600 font-medium cursor-pointer">Terms and Conditions</span>{' '}
//                             and{' '}
//                             <span className="text-pink-600 font-medium cursor-pointer">Privacy Policy</span>
//                         </p>
//                         <p style={{ fontFamily: 'Poppins' }} className="text-[16px] text-gray-600 text-center">
//                             Don’t have an account? <span className="text-pink-600 font-medium cursor-pointer">Sign Up here</span>
//                         </p>
