...
//     const [bedsBathsDropdownOpen, setBedsBathsDropdownOpen] = useState(false);
...
//         setBedsBathsDropdownOpen(false);
//     };
...
//     const toggleBedBath = () => setBedBathOpen(!bedBathOpen);
...
//         <>
//             <Navbar />
//             <div style={{ fontFamily: 'Poppins' }} className="flex flex-wrap gap-2 items-center justify-center p-4 bg-white shadow-sm rounded-md border w-full mx-auto">

//                 {/* Search input */}
//                 <div className="flex items-center border border-gray-300 rounded-md px-3 py-2 w-[360px]">
//                     <input
//                         type="text"
...
//                         className="border border-gray-300 rounded-md px-4 py-2 w-[149px] text-[16px] font-medium hover:bg-gray-100 flex justify-between items-center"
//                     >
...
//                     </button>
//                     {priceDropdownOpen && (
//                         <div className="absolute z-10 w-[300px] mt-1 bg-white border border-gray-300 rounded-md shadow-md p-4">
...
//                                     className="w-[130px] px-3 py-2 border border-gray-300 rounded-md text-sm"
//                                 />
//                                 <input
//                                     type="number"
//                                     placeholder="Maximum"
...
//                         className="border border-gray-300 rounded-md px-2 py-2 w-[154px] text-[16px] font-medium hover:bg-gray-100 flex justify-between items-center"
//                     >
//                         Beds & Baths <span className="ml-1">▾</span>
//                     </button>

//                     {bedBathOpen && (
//                         <div className="absolute z-10 w-[300px] mt-1 bg-white border border-gray-300 rounded-md shadow-md p-4 text-sm">
//                             {/* Bedrooms */}
//                             <div>
...
//                         className="border border-gray-300 rounded-md px-2 py-2 w-[149px] text-[16px] font-medium hover:bg-gray-100 flex justify-between items-center"
//                     >
//                         Home Type <span className="ml-1">▾</span>
//                     </button>

//                     {homeTypeOpen && (
//                         <div className="absolute z-10 w-[200px] mt-1 bg-white border border-gray-300 rounded-md shadow-md p-4 text-sm">
...
//                 {/* More Button */}
//                 <button className="border border-gray-300 rounded-md px-2 py-2 w-[149px] text-[16px] font-medium hover:bg-gray-100">
//                     More <span className="ml-1">▾</span>
//                 </button>

//                 {/* Save Search */}
//                 <button className="border border-gray-300 rounded-md px-4 py-2 text-sm bg-white hover:bg-gray-100">
//                     Save search
//                 </button>
//             </div>
//             <Map/>
