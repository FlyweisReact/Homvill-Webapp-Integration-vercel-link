    ...
    return (
        <>
            ...
            <div className="py-8 bg-[#F7F7F7]">
                <h2 className=" text-[20px] md:text-[36px] px-4  md:px-24 font-semibold mulish-font mb-6 text-[#1A1A1A]">Select your industry to get started</h2>

                <div className="grid grid-cols-1 px-4 xs:px-6 sm:px-12 md:px-12 lg:px-24 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 gap-6">
