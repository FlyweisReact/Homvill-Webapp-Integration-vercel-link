...
//         <div
//             className={`flex flex-col items-center justify-center border-2 border-dashed border-[#8A1538] rounded-md p-4 ${big ? 'w-[250px] h-[250px]' : 'w-[120px] h-[120px]'
//                 }`}
//         >
//             <FiUploadCloud size={big ? 48 : 24} className="text-gray-400" />
//             <p className={`text-center mt-2 text-sm ${big ? 'text-[#8A1538]' : 'text-[#8A1538]'}`}>
//                 Drop your files <br /> {big ? 'here or' : 'here'} <span className="text-[#8A1538] mulish-font cursor-pointer">{big && 'Browse'}</span>
            ...
            <div className="min-h-screen flex flex-col md:flex-row">
                ...
                <div className="w-full lg:w-2/3 p-6 md:p-12">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between text-[20px] mulish-font gap-4 mt-12 sm:gap-20">
                        ...
                        <button onClick={() => navigate('/video')} className="w-full bg-[#8A1538] mulish-font text-white py-2 rounded-md font-semibold hover:bg-[#72152e]">
                            Next
                        </button>
                    </div>
                </div>
