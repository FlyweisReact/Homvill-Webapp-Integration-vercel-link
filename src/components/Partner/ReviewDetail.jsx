...
//                     <h2 className="text-2xl md:text-[40px] mulish-font font-bold mb-4 text-center sm:text-left">Review</h2>
//                     <p className="text-sm md:text-[28px] mulish-font font-medium text-[#000000] mb-6 text-center sm:text-left">
//                         Your Listing Details
//                     </p>

//                     <div className="p-4 mx-">

//                         {/* Property Address Section */}
//                         <div className="bg-white p-4 rounded-lg text-[24px] shadow-md mb-4">
...
//                                         <img
//                                             src={tick}
//                                             className="w-4 h-4 text-green-500 absolute top-0 left-0"


//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font font-semibold">Property Address</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
...
//                                 </svg>
//                             </div>
//                             <p className="text-black mulish-font ml-20 mt-2"><span className="font-medium text-[#00000080]">Offer on:</span> 807 Madison Dr Chicago IL 60490</p>
//                             <p className="text-black ml-20 mulish-font"><span className="font-medium text-[#00000080]">For sale:</span> $550,000</p>
//                             <p className="text-black ml-20 mulish-font"><span className="font-medium text-[#00000080]">Home Facts:</span> House Selling</p>
//                         </div>

//                         {/* Home Features Section */}
//                         <div className="bg-white p-4 rounded-lg text-[24px] shadow-md">
//                             <div className="flex items-center justify-between">
//                                 <div className="flex items-center">
//                                     <div className="relative">
//                                         <img
...
//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font text-[30px] mulish-font font-semibold">Home Features</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
...
//                             </p>
//                         </div>
//                         <div className="bg-white p-4 rounded-lg text-[24px] shadow-md mt-8">
//                             <div className="flex items-center justify-between">
//                                 <div className="flex items-center">
//                                     <div className="relative">
//                                         <img
...
//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font text-[30px] mulish-font font-semibold">Home Description</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
...
//                             </div>
//                             <p className="text-black mt-2 ml-20 mulish-font">
//                                 <span className="font-medium text-[#00000080]">Note:</span> I remodeled my kitchen, upgrade the HVAC system,<br /> adding new roofing and installed hardwood floors.
//                             </p>

//                         </div>
//                         <div className="bg-white p-4 rounded-lg text-[24px] mt-8 shadow-md">
//                             <div className="flex items-center justify-between">
//                                 <div className="flex items-center">
//                                     <div className="relative">
//                                         <div className="bg-[#1D1D1D0D] rounded-full">
//                                             <img
//                                                 src={group}
//                                                 alt="House Icon"
...
//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font text-[30px] ml-2 mulish-font font-semibold">Price & Payment</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
...
//                                 </svg>
//                             </div>
//                             <p className="text-black mt-2 mulish-font">
//                                 <span className="font-medium ml-20 text-[#00000080]">Down Payment:</span> 20%
//                             </p>
//                             <p className="text-black mulish-font">
//                                 <span className="font-medium ml-20 text-[#00000080]">Offer Amount:</span> TBD
//                             </p>
//                             <p className="text-black mulish-font">
//                                 <span className="font-medium ml-20 text-[#00000080]">OL Refund:</span> TBD
//                             </p>

//                         </div>
//                         <div className="bg-white p-4 rounded-lg mt-8 text-[24px] shadow-md">
//                             <div className="flex items-center justify-between">
//                                 <div className="flex items-center">
//                                     <div className="relative">
//                                         <div className="bg-[#1D1D1D0D] rounded-full">
...
//                                             /> */}
//                                             <svg className="w-16 h-16  mr-2" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">

//                                                 <rect x="12" y="13" width="16" height="16" rx="3" stroke="#000" stroke-width="2" fill="none" />
...
//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font text-[30px] ml-2 mulish-font font-semibold">Photos & Videos</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
...
//                                 </svg>
//                             </div>
//                             <div className="flex overflow-x-auto space-x-4 ml-20 mt-4">
//                                 <img
//                                     src={sofa}
//                                     alt="Photo 1"
...
//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font text-[30px] ml-2 mulish-font font-semibold">Seller Information</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
//                                     fill="none"
...
//                                         />
//                                     </div>
//                                     <h2 className="text-[30px] mulish-font text-[30px] ml-2 mulish-font font-semibold">Open House</h2>
//                                 </div>
//                                 <svg onClick={() => navigate('/details')}
//                                     className="w-5 h-5 text-[#8A1538] cursor-pointer"
//                                     fill="none"
