...
import profile from '../assets/build3.svg';
...
const RecentWorks = () => {
    ...
    return (
        <div className=" mt-12 mb-12 bg-gray-50 px-4 sm:px-6 md:px-12 py-6 sm:py-8 md:py-10 mx-auto">
            <div className="flex flex-col min-[769px]:flex-row min-[769px]:[&>div]:w-1/4 min-[769px]:[&>div+div]:w-3/4 gap-4 sm:gap-6 md:gap-8">
